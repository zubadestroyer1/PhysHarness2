...
# approval. The build context is exactly this file plus workbench-requirements.lock
# (see docs/FORMAL_ENVIRONMENT.md, "Workbench v2 (pending rebuild)"). Replace every
