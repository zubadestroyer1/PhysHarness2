...
```json
{
  ...
  "scope_sha256": "f13defb821a8043a16978a83058abd1e6f7cbed8a60bd36549fb647efe3cd70f",
  "scope": {
    "protocol": "physharness-qualification-scope-v1",
    "image_metadata": {
      "path": "work/pilot-qualification-2026-09-23/attempt-01/image-metadata.json",
      "sha256": "fe7095a9c8a4fdd864925654af0edd03dac7106314bc2bf80c81e26b2a3c9442"
    },
    "runtime_identity": {
      "path": "work/pilot-qualification-2026-09-23/attempt-01/runtime-identity.json",
      "sha256": "87a27f64d4cff05d5061b490d7e0cf9c7470bb43911fb3a4d8e14d1c8f9be37a"
    },
    ...
    "inputs": {
      ...
      "src/physharness/service.py": "23f18f3341e80c6aef42a5af3951224e3269a0fa0a409b1f0666ffa9f387fbe0",
  ...
  "checks": [
    ...
    },
    {
      ...
      "evidence_sha256": "079dc82697dd14f421ec8756438508c5c70bc4844cb10811b2b9878942f34a77"
    },
    {
      "id": "core/independent_kernel",
      "status": "observed",
      "detail": "Exact fixed cases, modes, sources, causal outcomes and cleanup match.",
      "evidence_sha256": "f19c6612a3b3b1f64251a40145dca74947665270915266c0369ac3a5c417a395"
    },
    {
      "id": "library/kernel",
      "status": "observed",
      "detail": "Exact fixed cases, modes, sources, causal outcomes and cleanup match.",
      "evidence_sha256": "0b3ad2d18c1142f5dfdf25278e95bac450db9fd6ea67fef50e8f8a2b8f6f7c71"
    },
    {
      "id": "library/independent_kernel",
      "status": "observed",
      "detail": "Exact fixed cases, modes, sources, causal outcomes and cleanup match.",
      "evidence_sha256": "fa5c710ff320b0838648d81bb9bcd85e0bee7ff07f81b2e8bf6812b0bc773155"
    },
    {
      "id": "fixed-boundary",
      "status": "observed",
      "detail": "Fixed process, syscall, canary, writable control, inspected configuration and cleanup observations match.",
      "evidence_sha256": "459612a624d147c49485cfaf3fb82cf494188f93ddb6d997090bb787d2258bd6"
    },
    {
      ...
      "evidence_sha256": "6767bd22fbf4ca94a8b0e17432a666ab21e6a1a2c17dc524eda4d33f955e46ee"
    },
    {
