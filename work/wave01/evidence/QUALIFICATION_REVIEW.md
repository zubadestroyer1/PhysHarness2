...
```json
{
  ...
  "scope_sha256": "de7476c9d13aab9bd3654a613fd63d147e42efe24926ce48a0577604a0ddec40",
  "scope": {
    "protocol": "physharness-qualification-scope-v1",
    "image_metadata": {
      "path": "work/wave01/evidence/image-metadata.json",
      "sha256": "75be3be77a1ca65a153fb594d7e71ec72a5ec27b3aabe1e5e75323c580b9f573"
    },
    "runtime_identity": {
      "path": "work/wave01/evidence/runtime-identity.json",
      "sha256": "6d45b4cc785e74c75883e6c2bdb42ef3ba50639b7c89bb0614c990d0142474e5"
    },
    "image_digest": "sha256:82497fa412f10a76e515ddc8590f1c387a8383c8b99b1cd215261f6a11151246",
    "launcher_sha256": "aa6ce2b9e18cb24557b7732ae833d3d2062ea67b07f8df05b6370c41cbcee852",
    "driver_sha256": "0aa043a827abe8dd79960b59e3fcd3d249f5b0600e5e2c68aeb6dfb69e34445f",
    ...
    "inputs": {
      "formal/Dockerfile": "8cb18d42205e889c4b62276e731f8bc400c2b6c822a09ddd17541f7c493b43f9",
      ...
      "src/physharness/bootstrap.py": "47dbb328e31df2471ed8df680355e66505113d27d172d40e2268f3c7af775d18",
      "src/physharness/config.py": "55f885ba1bc496616fd5aa39f2f029051bf77be7eb46c5d86c236baf99353036",
      "src/physharness/domain.py": "79b48005bee551e69f26f5ebfbb320b3d71b80040986b3f855f4ec162506740e",
      "src/physharness/evaluation/evidence.py": "8d16ce3e23ca96b0e075499e52ead1b7a84e0d9f8c95673e465972f6e0fc7009",
      "src/physharness/service.py": "96c9299c13786cc9c4a33af5d23685ba29d4a852b07e7f2bde4c5b465a5b26ae",
      "src/physharness/verification/boundary.py": "aa6ce2b9e18cb24557b7732ae833d3d2062ea67b07f8df05b6370c41cbcee852",
      ...
      "src/physharness/verification/registry.py": "62ce492e30aae0bbbd25f46fbe8e2317cd7c9b8a7b4050af8e2a40dd4a20bd5c",
      ...
      "tests/test_research_services.py": "474550c52216f47c6165d8ca5dade0a0c33bca1df885102a0098c9d6c44fdffe",
      "tests/test_verification.py": "7704335f0aa65d255b4539302b4ec43fdc3e2826021e9e5a5cc5a36c2a53b5f3",
      ...
      "uv.lock": "2556e86db287163180bd8d8b022c20e6d14dfe171536ca079a83ccdca18a0990"
    }
  },
  ...
  "checks": [
    ...
    },
    {
      ...
      "evidence_sha256": "3334631bb7185043bcb8550b1e6efeb53f2454a65c25da6c6db9e0f74f92e1d4"
    },
    {
      "id": "core/independent_kernel",
      "status": "observed",
      "detail": "Exact fixed cases, modes, sources, causal outcomes and cleanup match.",
      "evidence_sha256": "5e7e86256cb44f76e3c03ee51cbdebf6d5ff71ac5b2bce21f56002456c0d435f"
    },
    {
      "id": "library/kernel",
      "status": "observed",
      "detail": "Exact fixed cases, modes, sources, causal outcomes and cleanup match.",
      "evidence_sha256": "071ba77355a37bd016a7ee4ba0605c542d7b7e5fcce6c7585d47c383a25b4364"
    },
    {
      "id": "library/independent_kernel",
      "status": "observed",
      "detail": "Exact fixed cases, modes, sources, causal outcomes and cleanup match.",
      "evidence_sha256": "cd9124b6f7de592fd2fcfdc5ef21d21f4733636f956677f1914781bf5c3fd58d"
    },
    {
      "id": "fixed-boundary",
      "status": "observed",
      "detail": "Fixed process, syscall, canary, writable control, inspected configuration and cleanup observations match.",
      "evidence_sha256": "db3915dd583c527f10c67a40fd8c30ee474094fcd1c484b121df5f5ef72afbe6"
    },
    {
      ...
      "evidence_sha256": "89e2dc04e98a4fa8ae95788009c174c5c17672444cdb36ec90823f039d77cacc"
    },
    {
  ...
  "coverage_gaps": [
    ...
    {
      "id": "driver-resource-deadline",
      "reason": "The pinned driver enforces 110 seconds and 100000 Comparator output bytes independently of the host timeout/output configuration. A contended library run reached this deadline and safely returned blocked/boundary_unqualified with cleanup. The generic code does not distinguish deadline from other boundary faults; larger host limits do not extend the driver limit."
    }
  ],
  "review_gates": [
    {
